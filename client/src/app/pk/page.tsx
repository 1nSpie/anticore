    ...
    <div className="min-h-screen bg-background dark:bg-backgroundDark py-12 px-6">
      <div className="max-w-4xl mx-auto bg-background1 dark:bg-backgroundDark1 shadow-lg rounded-lg p-8">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-5 space-y-2 text-black dark:text-white leading-relaxed">
            <li>
              <strong>5.1.</strong> Обработка персональных данных осуществляется
            ...
            <li>
              <strong>5.7.</strong> Хранение персональных данных осуществляется
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-5 space-y-2 text-black dark:text-white leading-relaxed">
            ...
            <li>
              ...
              систематизация, накопление, хранение, уничтожение и обезличивание
              персональных данных
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-5 space-y-2 text-black dark:text-white leading-relaxed">
            <li>
              <strong>7.1.</strong> Обработка персональных данных осуществляется
            ...
            <li>
              ...
              реализации интересов оператора или третьих лиц.
            </li>
            <li>
              <strong>7.6.</strong> Обработка общедоступных персональных данных.
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-5 space-y-2 text-black dark:text-white leading-relaxed mt-2">
            ...
            <li>
              <strong>8.2.</strong> Персональные данные Пользователя никогда не
              передаются третьим лицам, за исключением случаев, связанных с
            ...
            <li>
              <strong>8.5.</strong> Информация, собранная сторонними сервисами,
              обрабатывается в соответствии с их политикой конфиденциальности.
            </li>
          </ul>
        </section>
        ...
        <div className="text-center mt-8">
          <Link
            href="/glav"
            className="inline-block px-6 py-2 bg-orange text-white rounded-md hover:bg-orange-500 transition"
          >

    ...
    >
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        >
          <Link
            href="/blog"
            className="inline-flex items-center text-orangeDefault hover:text-orange-600 transition-colors"
          >
        ...
        >
          <div className="flex items-center space-x-2 mb-4 flex-wrap">
            <span className="bg-orangeDefault text-white px-3 py-1 rounded-full text-sm font-medium mt-2">
              {post.category.name}
            </span>
              ...
              {relatedPosts.map((relatedPost) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <h3 className="font-semibold text-black dark:text-white mb-2 line-clamp-2 group-hover:text-orangeDefault transition-colors">
                      {relatedPost.title}
                    </h3>

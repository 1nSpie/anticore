              ...
              <ul className="mt-2 space-y-2">
                <li className="flex gap-x-3 items-center">
                  ...
                  <span className="text-gray-600 dark:text-neutral-400">
                    Используем только высококачественные материалы от
                ...
                <li className="flex gap-x-3 items-center">
                  {svgIcon}
                  <span className="text-gray-600 dark:text-neutral-400">
                    Предоставляем гарантию на все виды работ и соблюдаем сроки
                    выполнения услуг
                  </span>
                </li>
                <li className="flex gap-x-3 items-center">
                  {svgIcon}
                  <span className="text-gray-600 dark:text-neutral-400">
                    Обеспечиваем индивидуальный подход и профессиональную
                ...
                {watch("triggerNotAuto") ? (
                  <div className="mt-6 grid gap-6">
                    <div className="w-[100%]">
                      ...
                      <Input id="input-label" placeholder="BMW" />
                    </div>
                    <div className="w-[100%]">
                      <label
                        htmlFor="input-label"
                      ...
                      <Input id="input-label" placeholder="X3" />
                    </div>
                  </div>
                ) : (
                  <div className="mt-6 grid gap-4 lg:gap-6">
                    <div>
                      ...
                      <Select
                        onValueChange={(v) =>
                          handleSelectAuto(v, EnumType.MARKA)
                        }
                      >

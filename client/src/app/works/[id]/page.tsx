...
import { ArrowLeft, Clock, Calendar, Car, CheckCircle, Image as ImageIcon } from "lucide-react";
import { worksApi, Work } from "../worksApi";
    ...
    return (
      <div className="min-h-screen bg-background1 dark:bg-backgroundDark flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-4">{error || 'Работа не найдена'}</p>
          <button
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-6 text-gray-600 dark:text-gray-300">
            <div className="flex items-center gap-2">
              <Car size={18} />
              <span>{work.carBrand} {work.carModel}</span>
            </div>
            <div className="flex items-center gap-2">
              <Clock size={18} />
            ...
            <div className="flex items-center gap-2">
              <Calendar size={18} />
              <span>{new Date(work.createdAt).toLocaleDateString('ru-RU')}</span>
            </div>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <motion.div
              ...
              className="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-6"
            >
              <h3 className="text-xl font-bold text-black dark:text-white mb-3">
                Нужна подобная работа?
              </h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                Закажите профессиональную антикоррозийную обработку для своего автомобиля
              </p>
              <div className="space-y-3">
                <button className="w-full bg-orangeDefault hover:bg-orange-600 text-white font-semibold py-3 px-4 rounded-lg transition-colors">
                  Записаться на обработку
                </button>
                <button className="w-full bg-greenDefault hover:bg-greenDefaultHover text-white font-semibold py-3 px-4 rounded-lg transition-colors">
      ...
      {selectedImage && (
        ...
        >
          <div className="relative max-w-4xl max-h-full">
            ...
            <div className="bg-gray-200 dark:bg-gray-700 rounded-lg aspect-[4/3] flex items-center justify-center">
